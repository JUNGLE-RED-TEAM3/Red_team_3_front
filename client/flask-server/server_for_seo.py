    ...
    while True:
        ...
        if len(lmList)!=0:
            ...
            if fingers[1] and fingers[2]:
                ...
                #checking for click
                if y1 < 40:
                    if 75 < x1 < 135:#if i m clicking at purple brush
                        header = overlayList[1]
                        # drawColor = (255, 0, 255)
                        brushThickness = brushTest
                    elif 200 < x1 < 270:#if i m clicking at blue brush
                        ...
                        if drawColor == (255,100,0):
                            ...
                            drawColor=(255,100,0)
                    elif 330 < x1 < 430:#if i m clicking at green brush
                        header = overlayList[3]
                        # drawColor = (0, 255, 0)
                        drawColor=(0,0,0)
                    elif 490 < x1 < 560:#if i m clicking at eraser
        ...
        img[0:40,0:640]=header # on our frame we are setting our JPG image acc to H,W of jpg images
        ...
        img = overlay_transparent(img, overlayList2[6], 320, 180, overlay_size=None)
