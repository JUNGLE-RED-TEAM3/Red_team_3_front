...
def get_frames():
    ...
    brushTest = 10
    eraserThickness = 70
    drawColor=(255,100,0)#setting purple color
    xp, yp = 0, 0
    ...
    while True:
        ...
        if len(lmList)!=0:
            ...
            if fingers[1] and fingers[2]:
                ...
                #checking for click
                if y1 < 125:
                    if 200 < x1 < 300:#if i m clicking at purple brush
                        if drawColor == (0,0,255):
                            header = overlayList[5]
                        # drawColor = (255, 0, 255)
                        brushThickness = brushTest
                    elif 630 < x1 < 730:#if i m clicking at blue brush
                            header = overlayList[0]
                            drawColor = (255, 100, 0)
                    elif 1110 < x1 < 1250:#if i m clicking at green brush
                        if drawColor == (255,100,0):
                            header = overlayList[2]
                        if drawColor == (0,0,255):
                            header = overlayList[6]
                        drawColor=(0,0,0)
                    elif 1540 < x1 < 1640:#if i m clicking at eraser
        ...
        img[0:125,60:1860]=header # on our frame we are setting our JPG image acc to H,W of jpg images
        ...
        # print(num_channels)
        img = overlay_transparent(img, overlayList2[6], 960, 540, overlay_size=(600, 600))
        #/JUNHO: 끝
